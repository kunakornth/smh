...
class HowToUse2 extends Component{
            ...
            <Container>
                ...
                <View style={{flex:1, flexDirection: 'row'}}>
                    ...
                    <View style={{flex:8 ,flexDirection: 'column',alignItems: 'center',}} >
                        ...
                        <Text style={{fontSize: 25,}}>Smart Device network</Text>
                        ...
                        <Text style={{marginTop:5}}> Connect to your Smart Device's Wi-Fi network. It looks something like this:</Text>
                        <Image
                        ...
                        <TouchableOpacity style={{marginTop:55}} onPress={this.oncheck.bind(this)}>
                            <Text style={{marginTop:10 , color:'#057ce4'}} >I connected to my Smart Device's Wi-Fi.</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{flex:1 }} />
                </View>
...
export default connect()(HowToUse2);